...
:func:`ml_analysis.features.materialize.to_windowed` and
:func:`ml_analysis.features.materialize.to_period` to produce one column per
...
defined in :mod:`ml_analysis.features.builtins` and populate the default
registry on import.
"""
