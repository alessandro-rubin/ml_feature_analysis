...
directly or subclass it to add their own settings (``tessa.Config``
does exactly that).
"""
...
@dataclass
class LoaderConfig:
    """On-disk layout settings consumed by :mod:`asset_loader.loader`.
    ...
    filename_pattern : str
        ...
        on :attr:`timestamp_col` (see :mod:`asset_loader.loader`). A pattern
